/* cash out toggler button */
const cashOutBtn = document.getElementById("cash-out-btn");
cashOutBtn.addEventListener("click", function () {
    //change btn click style
    toggleStyleBtn("cash-out-btn");

    //show add money form section
    showFormSection("cash-out-form");
});
...
document.getElementById("cashOut-btn").addEventListener("click", function (event) {
    ...
    if (pinNumber === 1234) {
        ...
        div.innerHTML = `
            <div class="px-4 py-3 bg-white border border-[#0808081A] rounded-xl flex justify-between items-center mb-3">
                        <div class="flex gap-2 items-center">
                            ...
                            <div>
                                <h4 class="text-base font-semibold text-[#080808B2]">Cash Out</h4>
        ...
        alert("Failed to cash. Please try again later");
        return;
    }
});